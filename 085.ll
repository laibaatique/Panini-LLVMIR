; ModuleID = '085.c'
source_filename = "085.c"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-w64-windows-gnu"

@.str = private unnamed_addr constant [11 x i8] c"Exception\0A\00", align 1
@.str.1 = private unnamed_addr constant [12 x i8] c"s[0] == 'a'\00", align 1
@.str.2 = private unnamed_addr constant [6 x i8] c"085.c\00", align 1
@.str.3 = private unnamed_addr constant [4 x i8] c"%c\0A\00", align 1

; Function Attrs: nounwind uwtable
define dso_local noundef i8 @f085(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
...
10:                                               ; preds = %7
  tail call void @_assert(ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, i32 noundef 13) #12
  unreachable
...
declare dllimport void @_assert(ptr noundef, ptr noundef, i32 noundef) local_unnamed_addr #5
...
18:                                               ; preds = %15
  %19 = call ptr @__acrt_iob_func(i32 noundef 2) #10
  %20 = call i32 (ptr, ptr, ...) @__mingw_fprintf(ptr noundef %19, ptr noundef nonnull @.str) #10
...
24:                                               ; preds = %21
  call void @_assert(ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, i32 noundef 13) #12
  unreachable

25:                                               ; preds = %21
  %26 = call i32 (ptr, ...) @__mingw_printf(ptr noundef nonnull @.str.3, i32 noundef 97) #10
