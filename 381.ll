; ModuleID = '381.c'
source_filename = "381.c"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-w64-windows-gnu"

@.str.1 = private unnamed_addr constant [20 x i8] c"strcmp(s, \22b\22) == 0\00", align 1
@.str.2 = private unnamed_addr constant [6 x i8] c"381.c\00", align 1

; Function Attrs: nounwind uwtable
define dso_local void @f381(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
...
4:                                                ; preds = %7
  %5 = add nuw i64 %8, 1
  %6 = icmp eq i64 %5, %2
  br i1 %6, label %20, label %7, !llvm.loop !5
...
19:                                               ; preds = %12, %15
  tail call void @_assert(ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, i32 noundef 17) #9
  unreachable
...
15:                                               ; preds = %9, %5
  ...
  %17 = icmp eq i64 %16, 0
  br i1 %17, label %34, label %21

18:                                               ; preds = %21
  %19 = add nuw i64 %22, 1
  %20 = icmp eq i64 %19, %16
  br i1 %20, label %34, label %21, !llvm.loop !5
...
33:                                               ; preds = %26
  call void @_assert(ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, i32 noundef 17) #9
  unreachable
