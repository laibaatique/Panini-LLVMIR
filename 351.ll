...
define dso_local void @f351(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
...
9:                                                ; preds = %5
  %10 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %0) #9
  %11 = icmp eq i64 %10, 2
...
16:                                               ; preds = %12
  tail call void @_assert(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 13) #8
  unreachable
...
20:                                               ; preds = %17
  tail call void @_assert(ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.1, i32 noundef 14) #8
  unreachable
...
15:                                               ; preds = %9, %5
  call void @f351(ptr noundef nonnull %3)
