...
define dso_local void @f084(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
  ...
  %5 = call i32 @memcmp(ptr noundef nonnull dereferenceable(2) %2, ptr noundef nonnull dereferenceable(2) @.str, i64 2)
  %6 = icmp eq i32 %5, 0
...
16:                                               ; preds = %10, %6
  ...
  %19 = call i32 @memcmp(ptr noundef nonnull dereferenceable(2) %3, ptr noundef nonnull dereferenceable(2) @.str, i64 2)
  %20 = icmp eq i32 %19, 0
...
22:                                               ; preds = %16
  %23 = call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %4) #9
  %24 = icmp eq i64 %23, 1
