; ModuleID = '123.c'
source_filename = "123.c"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-w64-windows-gnu"

@.str = private unnamed_addr constant [14 x i8] c"strlen(s) > 0\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"123.c\00", align 1
@.str.2 = private unnamed_addr constant [21 x i8] c"i > 0 || s[i] == 'a'\00", align 1

; Function Attrs: nounwind uwtable
define dso_local void @f123(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
...
9:                                                ; preds = %1
  tail call void @_assert(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 10) #7
  unreachable

10:                                               ; preds = %4
  tail call void @_assert(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 12) #7
  unreachable
...
23:                                               ; preds = %15
  call void @_assert(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 10) #7
  unreachable

24:                                               ; preds = %18
  call void @_assert(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 12) #7
  unreachable
