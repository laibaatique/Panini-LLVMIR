; ModuleID = '471.c'
source_filename = "471.c"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-w64-windows-gnu"

@.str = private unnamed_addr constant [12 x i8] c"s[0] == '0'\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"471.c\00", align 1
@.str.2 = private unnamed_addr constant [16 x i8] c"s[i + 1] != '1'\00", align 1
@.str.3 = private unnamed_addr constant [12 x i8] c"s[i] == '0'\00", align 1
@.str.4 = private unnamed_addr constant [27 x i8] c"s[i] == '0' || s[i] == '1'\00", align 1

; Function Attrs: nounwind uwtable
define dso_local void @f471(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
...
17:                                               ; preds = %8
  tail call void @_assert(ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.1, i32 noundef 19) #9
  unreachable
...
31:                                               ; preds = %29
  tail call void @_assert(ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.1, i32 noundef 26) #9
  unreachable
...
35:                                               ; preds = %32
  tail call void @_assert(ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.1, i32 noundef 28) #9
  unreachable

36:                                               ; preds = %3, %1, %32, %21, %29
  ret void
}
...
15:                                               ; preds = %9, %5
  call void @f471(ptr noundef nonnull %3)
