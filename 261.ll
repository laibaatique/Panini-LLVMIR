; ModuleID = '261.c'
source_filename = "261.c"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-w64-windows-gnu"

@.str = private unnamed_addr constant [12 x i8] c"s[0] == 'b'\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"261.c\00", align 1
@.str.2 = private unnamed_addr constant [12 x i8] c"s[0] == 'a'\00", align 1
@.str.3 = private unnamed_addr constant [12 x i8] c"s[1] == 'b'\00", align 1

; Function Attrs: nounwind uwtable
define dso_local void @f261(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
...
10:                                               ; preds = %7
  tail call void @_assert(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 12) #10
  unreachable
...
15:                                               ; preds = %11
  tail call void @_assert(ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.1, i32 noundef 13) #10
  unreachable
...
15:                                               ; preds = %9, %5
  call void @f261(ptr noundef nonnull %3)
