; ModuleID = '332.c'
source_filename = "332.c"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-w64-windows-gnu"

@.str = private unnamed_addr constant [9 x i8] c"a == 'a'\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"332.c\00", align 1
@.str.2 = private unnamed_addr constant [9 x i8] c"b == 'b'\00", align 1

; Function Attrs: nounwind uwtable
define dso_local void @f332(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
...
3:                                                ; preds = %1
  tail call void @_assert(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 13) #7
  unreachable
...
8:                                                ; preds = %4
  tail call void @_assert(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 14) #7
  unreachable
...
17:                                               ; preds = %15
  call void @_assert(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 13) #7
  unreachable

18:                                               ; preds = %15
  %19 = getelementptr inbounds nuw i8, ptr %3, i64 2
  %20 = load i8, ptr %19, align 2, !tbaa !5
  %21 = icmp eq i8 %20, 98
  br i1 %21, label %23, label %22

22:                                               ; preds = %18
  call void @_assert(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 14) #7
  unreachable
