; ModuleID = '183.c'
source_filename = "183.c"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-w64-windows-gnu"

@.str = private unnamed_addr constant [24 x i8] c"s[strlen(s) - 1] == 'a'\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"183.c\00", align 1
@.str.2 = private unnamed_addr constant [24 x i8] c"s[strlen(s) - 2] != 'a'\00", align 1
@.str.3 = private unnamed_addr constant [15 x i8] c"strlen(s) == 2\00", align 1

; Function Attrs: nounwind uwtable
define dso_local void @f183(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
...
12:                                               ; preds = %8
  tail call void @_assert(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 10) #9
  unreachable
...
15:                                               ; preds = %13
  tail call void @_assert(ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.1, i32 noundef 11) #9
  unreachable
...
22:                                               ; preds = %15
  %23 = getelementptr i8, ptr %17, i64 -2
  %24 = load i8, ptr %23, align 1, !tbaa !5
  %25 = icmp eq i8 %24, 97
  br i1 %25, label %26, label %27

26:                                               ; preds = %22
  call void @_assert(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 10) #9
  unreachable
...
29:                                               ; preds = %27
  call void @_assert(ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.1, i32 noundef 11) #9
  unreachable
