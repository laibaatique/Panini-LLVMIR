; ModuleID = '002.c'
source_filename = "002.c"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-w64-windows-gnu"

@.str.1 = private unnamed_addr constant [11 x i8] c"Exception\0A\00", align 1

; Function Attrs: nounwind uwtable
define dso_local void @f002(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
  %2 = load i8, ptr %0, align 1
  %3 = icmp eq i8 %2, 0
  br i1 %3, label %7, label %4

4:                                                ; preds = %1
  %5 = tail call ptr @__acrt_iob_func(i32 noundef 2) #8
  %6 = tail call i32 (ptr, ptr, ...) @__mingw_fprintf(ptr noundef %5, ptr noundef nonnull @.str.1) #8
...
18:                                               ; preds = %15
  %19 = call ptr @__acrt_iob_func(i32 noundef 2) #8
  %20 = call i32 (ptr, ptr, ...) @__mingw_fprintf(ptr noundef %19, ptr noundef nonnull @.str.1) #8
