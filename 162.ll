; ModuleID = '162.c'
source_filename = "162.c"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-w64-windows-gnu"

@.str = private unnamed_addr constant [15 x i8] c"strlen(s) <= 1\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"162.c\00", align 1
@.str.2 = private unnamed_addr constant [23 x i8] c"strchr(s, 'a') == NULL\00", align 1

; Function Attrs: nounwind uwtable
define dso_local void @f162(ptr noundef readonly %0) local_unnamed_addr #0 {
...
5:                                                ; preds = %1
  %6 = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %0, i32 noundef 97) #8
...
19:                                               ; preds = %15
  %20 = call ptr @strchr(ptr noundef nonnull readonly dereferenceable(1) %3, i32 noundef 97) #8
