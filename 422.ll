; ModuleID = '422.c'
source_filename = "422.c"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-w64-windows-gnu"

@.str = private unnamed_addr constant [11 x i8] c"Exception\0A\00", align 1
@.str.1 = private unnamed_addr constant [15 x i8] c"strlen(s) == 1\00", align 1
@.str.2 = private unnamed_addr constant [6 x i8] c"422.c\00", align 1

; Function Attrs: nounwind uwtable
define dso_local void @f422(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
...
5:                                                ; preds = %1
  %6 = tail call ptr @__acrt_iob_func(i32 noundef 2) #10
  %7 = tail call i32 (ptr, ptr, ...) @__mingw_fprintf(ptr noundef %6, ptr noundef nonnull @.str) #10
  tail call void @exit(i32 noundef 1) #11
  unreachable

8:                                                ; preds = %1
  %9 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %0) #10
  %10 = icmp eq i64 %9, 1
  br i1 %10, label %12, label %11

11:                                               ; preds = %8
  tail call void @_assert(ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, i32 noundef 18) #12
  unreachable
...
19:                                               ; preds = %15
  %20 = call ptr @__acrt_iob_func(i32 noundef 2) #10
  %21 = call i32 (ptr, ptr, ...) @__mingw_fprintf(ptr noundef %20, ptr noundef nonnull @.str) #10
  call void @exit(i32 noundef 1) #11
  unreachable

22:                                               ; preds = %15
  %23 = call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %3) #10
  %24 = icmp eq i64 %23, 1
  br i1 %24, label %26, label %25

25:                                               ; preds = %22
  call void @_assert(ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, i32 noundef 18) #12
  unreachable
