...
define dso_local i8 @f015(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
  %2 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %0) #9
  %3 = icmp eq i64 %2, 1
  br i1 %3, label %7, label %4

4:                                                ; preds = %1
  %5 = tail call ptr @__acrt_iob_func(i32 noundef 2) #9
  %6 = tail call i32 (ptr, ptr, ...) @__mingw_fprintf(ptr noundef %5, ptr noundef nonnull @.str) #9
...
18:                                               ; preds = %15
  %19 = call ptr @__acrt_iob_func(i32 noundef 2) #9
  %20 = call i32 (ptr, ptr, ...) @__mingw_fprintf(ptr noundef %19, ptr noundef nonnull @.str) #9
...
21:                                               ; preds = %15
  ...
  %24 = call i32 (ptr, ...) @__mingw_printf(ptr noundef nonnull @.str.1, i32 noundef %23) #9
