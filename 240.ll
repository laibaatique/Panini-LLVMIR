; ModuleID = '240.c'
source_filename = "240.c"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-w64-windows-gnu"

@.str = private unnamed_addr constant [15 x i8] c"i == strlen(s)\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"240.c\00", align 1

; Function Attrs: nounwind uwtable
define dso_local void @f240(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
...
16:                                               ; preds = %19
  ...
  br i1 %18, label %19, label %24, !llvm.loop !10

19:                                               ; preds = %12, %16
  %20 = phi i64 [ %17, %16 ], [ %14, %12 ]
...
24:                                               ; preds = %16, %19, %12
  %25 = phi i64 [ %14, %12 ], [ %20, %19 ], [ %17, %16 ]
  %26 = icmp eq i64 %2, %25
  br i1 %26, label %28, label %27

27:                                               ; preds = %24
  tail call void @_assert(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 25) #9
  unreachable
...
38:                                               ; preds = %33, %26
  %39 = phi i64 [ %28, %26 ], [ %34, %33 ]
  %40 = icmp eq i64 %16, %39
  br i1 %40, label %42, label %41

41:                                               ; preds = %38
  call void @_assert(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 25) #9
  unreachable
