; ModuleID = '061.c'
source_filename = "061.c"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-w64-windows-gnu"

@.str = private unnamed_addr constant [15 x i8] c"strlen(s) <= 3\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"061.c\00", align 1
@f061.result = internal global [4 x i8] zeroinitializer, align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1

; Function Attrs: nounwind uwtable
define dso_local noundef nonnull ptr @f061(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
...
5:                                                ; preds = %1
  ...
  store i8 %6, ptr @f061.result, align 1, !tbaa !5
  %7 = getelementptr inbounds nuw i8, ptr %0, i64 1
  %8 = load i8, ptr %7, align 1, !tbaa !5
  store i8 %8, ptr getelementptr inbounds nuw (i8, ptr @f061.result, i64 1), align 1, !tbaa !5
  %9 = getelementptr inbounds nuw i8, ptr %0, i64 2
  %10 = load i8, ptr %9, align 1, !tbaa !5
  store i8 %10, ptr getelementptr inbounds nuw (i8, ptr @f061.result, i64 2), align 1, !tbaa !5
  store i8 0, ptr getelementptr inbounds nuw (i8, ptr @f061.result, i64 3), align 1, !tbaa !5
  ret ptr @f061.result
}
...
19:                                               ; preds = %15
  ...
  store i8 %20, ptr @f061.result, align 1, !tbaa !5
  %21 = getelementptr inbounds nuw i8, ptr %3, i64 1
  %22 = load i8, ptr %21, align 1, !tbaa !5
  store i8 %22, ptr getelementptr inbounds nuw (i8, ptr @f061.result, i64 1), align 1, !tbaa !5
  %23 = getelementptr inbounds nuw i8, ptr %3, i64 2
  %24 = load i8, ptr %23, align 2, !tbaa !5
  store i8 %24, ptr getelementptr inbounds nuw (i8, ptr @f061.result, i64 2), align 1, !tbaa !5
  store i8 0, ptr getelementptr inbounds nuw (i8, ptr @f061.result, i64 3), align 1, !tbaa !5
  %25 = call i32 (ptr, ...) @__mingw_printf(ptr noundef nonnull @.str.2, ptr noundef nonnull @f061.result) #8
