; ModuleID = '067.c'
source_filename = "067.c"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-w64-windows-gnu"

@.str = private unnamed_addr constant [15 x i8] c"strlen(s) <= 3\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"067.c\00", align 1
@f067.result = internal global [4 x i8] zeroinitializer, align 1

; Function Attrs: nounwind uwtable
define dso_local noundef nonnull ptr @f067(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
  %2 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %0) #9
  %3 = icmp ult i64 %2, 4
  br i1 %3, label %5, label %4

4:                                                ; preds = %1
  tail call void @_assert(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 9) #10
  unreachable

5:                                                ; preds = %1
  %6 = tail call ptr @strncpy(ptr noundef nonnull dereferenceable(1) @f067.result, ptr noundef nonnull dereferenceable(1) %0, i64 noundef 3) #9
  store i8 0, ptr getelementptr inbounds nuw (i8, ptr @f067.result, i64 3), align 1, !tbaa !5
  ret ptr @f067.result
}
...
18:                                               ; preds = %15
  call void @_assert(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 9) #10
  unreachable

19:                                               ; preds = %15
  %20 = call ptr @strncpy(ptr noundef nonnull dereferenceable(1) @f067.result, ptr noundef nonnull readonly dereferenceable(1) %3, i64 noundef 3) #9
  store i8 0, ptr getelementptr inbounds nuw (i8, ptr @f067.result, i64 3), align 1, !tbaa !5
