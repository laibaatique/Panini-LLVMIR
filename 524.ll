; ModuleID = '524.c'
source_filename = "524.c"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-w64-windows-gnu"

@.str = private unnamed_addr constant [10 x i8] c"a1 == 'a'\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"524.c\00", align 1
@.str.2 = private unnamed_addr constant [10 x i8] c"a2 == 'a'\00", align 1

; Function Attrs: nounwind uwtable
define dso_local void @f524(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
  %2 = load i8, ptr %0, align 1, !tbaa !5
  %3 = icmp eq i8 %2, 97
  br i1 %3, label %5, label %4

4:                                                ; preds = %1
  tail call void @_assert(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 11) #7
  unreachable
...
18:                                               ; preds = %15
  call void @_assert(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 11) #7
  unreachable
