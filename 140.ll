...
define dso_local i32 @f140(ptr noundef %0) local_unnamed_addr #0 {
...
15:                                               ; preds = %9, %5
  %16 = call ptr @strchr(ptr noundef nonnull dereferenceable(1) %3, i32 noundef 97) #8
  ...
  %23 = call i32 (ptr, ...) @__mingw_printf(ptr noundef nonnull @.str, i32 noundef %22) #8
