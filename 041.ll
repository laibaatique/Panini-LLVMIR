; ModuleID = '041.c'
source_filename = "041.c"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-w64-windows-gnu"

@.str = private unnamed_addr constant [15 x i8] c"strlen(s) <= 2\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"041.c\00", align 1
@f041.r = internal global [3 x i8] zeroinitializer, align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1

; Function Attrs: nounwind uwtable
define dso_local noundef nonnull ptr @f041(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
...
5:                                                ; preds = %1
  ...
  store i8 %6, ptr @f041.r, align 1, !tbaa !5
  %7 = getelementptr inbounds nuw i8, ptr %0, i64 1
  %8 = load i8, ptr %7, align 1, !tbaa !5
  store i8 %8, ptr getelementptr inbounds nuw (i8, ptr @f041.r, i64 1), align 1, !tbaa !5
  store i8 0, ptr getelementptr inbounds nuw (i8, ptr @f041.r, i64 2), align 1, !tbaa !5
  ret ptr @f041.r
}
...
19:                                               ; preds = %15
  ...
  store i8 %20, ptr @f041.r, align 1, !tbaa !5
  %21 = getelementptr inbounds nuw i8, ptr %3, i64 1
  %22 = load i8, ptr %21, align 1, !tbaa !5
  store i8 %22, ptr getelementptr inbounds nuw (i8, ptr @f041.r, i64 1), align 1, !tbaa !5
  store i8 0, ptr getelementptr inbounds nuw (i8, ptr @f041.r, i64 2), align 1, !tbaa !5
  %23 = call i32 (ptr, ...) @__mingw_printf(ptr noundef nonnull @.str.2, ptr noundef nonnull @f041.r) #8
