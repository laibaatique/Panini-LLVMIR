; ModuleID = '441.c'
source_filename = "441.c"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-w64-windows-gnu"

@.str = private unnamed_addr constant [12 x i8] c"s[1] == 'b'\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"441.c\00", align 1
@.str.2 = private unnamed_addr constant [15 x i8] c"strlen(s) <= 2\00", align 1
@.str.3 = private unnamed_addr constant [12 x i8] c"s[0] == 'c'\00", align 1
@.str.4 = private unnamed_addr constant [15 x i8] c"strlen(s) == 1\00", align 1

; Function Attrs: nounwind uwtable
define dso_local void @f441(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
...
7:                                                ; preds = %3
  tail call void @_assert(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 10) #8
  unreachable
...
11:                                               ; preds = %8
  tail call void @_assert(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 11) #8
  unreachable

12:                                               ; preds = %1
  tail call void @_assert(ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.1, i32 noundef 13) #8
  unreachable
...
16:                                               ; preds = %13
  tail call void @_assert(ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.1, i32 noundef 14) #8
  unreachable
...
15:                                               ; preds = %9, %5
  call void @f441(ptr noundef nonnull %3)
