; ModuleID = '392.c'
source_filename = "392.c"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-w64-windows-gnu"

@.str = private unnamed_addr constant [89 x i8] c"strlen(s) == 0 || (strlen(s) == 1 && (strchr(s, 'a') != NULL || strchr(s, 'b') != NULL))\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"392.c\00", align 1

; Function Attrs: nounwind uwtable
define dso_local void @f392(ptr noundef readonly %0) local_unnamed_addr #0 {
...
3:                                                ; preds = %1
  %4 = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %0, i32 noundef 97) #8
  %5 = icmp eq ptr %4, null
  br i1 %5, label %6, label %10

6:                                                ; preds = %3
  %7 = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %0, i32 noundef 98) #8
...
17:                                               ; preds = %15
  %18 = call ptr @strchr(ptr noundef nonnull readonly dereferenceable(1) %3, i32 noundef 97) #8
  %19 = icmp eq ptr %18, null
  br i1 %19, label %20, label %24

20:                                               ; preds = %17
  %21 = call ptr @strchr(ptr noundef nonnull readonly dereferenceable(1) %3, i32 noundef 98) #8
