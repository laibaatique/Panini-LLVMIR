; ModuleID = '450.c'
source_filename = "450.c"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-w64-windows-gnu"

@.str = private unnamed_addr constant [16 x i8] c"s[i + 0] == 'a'\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"450.c\00", align 1
@.str.2 = private unnamed_addr constant [35 x i8] c"s[i + 1] != 'a' && s[i + 1] != 'b'\00", align 1
@.str.3 = private unnamed_addr constant [16 x i8] c"s[i + 2] == 'b'\00", align 1

; Function Attrs: nounwind uwtable
define dso_local void @f450(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
...
23:                                               ; preds = %19
  tail call void @_assert(ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.1, i32 noundef 13) #9
  unreachable
...
37:                                               ; preds = %33
  call void @_assert(ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.1, i32 noundef 13) #9
  unreachable
