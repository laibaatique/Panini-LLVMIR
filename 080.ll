; ModuleID = '080.c'
source_filename = "080.c"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-w64-windows-gnu"

@.str.1 = private unnamed_addr constant [19 x i8] c"strcmp(\22a\22,s) == 0\00", align 1
@.str.2 = private unnamed_addr constant [6 x i8] c"080.c\00", align 1

; Function Attrs: nounwind uwtable
define dso_local void @f080(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
...
14:                                               ; preds = %11
  tail call void @_assert(ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, i32 noundef 9) #7
  unreachable
...
15:                                               ; preds = %9, %5
  ...
  %18 = sub nsw i32 97, %17
  %19 = icmp eq i8 %16, 97
  %20 = getelementptr inbounds nuw i8, ptr %3, i64 1
  %21 = load i8, ptr %20, align 1
  %22 = zext i8 %21 to i32
  %23 = sub nsw i32 0, %22
  %24 = select i1 %19, i32 %23, i32 %18
  %25 = icmp eq i32 %24, 0
  br i1 %25, label %27, label %26

26:                                               ; preds = %15
  call void @_assert(ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, i32 noundef 9) #7
  unreachable
