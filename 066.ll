; ModuleID = '066.c'
source_filename = "066.c"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-w64-windows-gnu"

@.str = private unnamed_addr constant [11 x i8] c"Exception\0A\00", align 1
@f066.result = internal global [4 x i8] zeroinitializer, align 1

; Function Attrs: nounwind uwtable
define dso_local noundef nonnull ptr @f066(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
...
7:                                                ; preds = %1
  %8 = tail call ptr @strncpy(ptr noundef nonnull dereferenceable(1) @f066.result, ptr noundef nonnull dereferenceable(1) %0, i64 noundef 3) #10
  store i8 0, ptr getelementptr inbounds nuw (i8, ptr @f066.result, i64 3), align 1, !tbaa !5
  ret ptr @f066.result
}
...
21:                                               ; preds = %15
  %22 = call ptr @strncpy(ptr noundef nonnull dereferenceable(1) @f066.result, ptr noundef nonnull readonly dereferenceable(1) %3, i64 noundef 3) #10
  store i8 0, ptr getelementptr inbounds nuw (i8, ptr @f066.result, i64 3), align 1, !tbaa !5
