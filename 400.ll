; ModuleID = '400.c'
source_filename = "400.c"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-w64-windows-gnu"

@.str = private unnamed_addr constant [15 x i8] c"i == strlen(s)\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"400.c\00", align 1

; Function Attrs: nounwind uwtable
define dso_local void @f400(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
...
24:                                               ; preds = %16, %21, %12, %1
  %25 = phi i64 [ %13, %12 ], [ 0, %1 ], [ %17, %16 ], [ %2, %21 ]
  %26 = and i64 %25, 4294967295
  %27 = icmp eq i64 %2, %26
  br i1 %27, label %29, label %28

28:                                               ; preds = %24
  tail call void @_assert(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 26) #9
  unreachable
...
38:                                               ; preds = %30, %35, %26, %15
  %39 = phi i64 [ %27, %26 ], [ 0, %15 ], [ %31, %30 ], [ %16, %35 ]
  %40 = and i64 %39, 4294967295
  %41 = icmp eq i64 %16, %40
  br i1 %41, label %43, label %42

42:                                               ; preds = %38
  call void @_assert(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 26) #9
  unreachable
