; ModuleID = '072.c'
source_filename = "072.c"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-w64-windows-gnu"

@f072.r = internal global [3 x i8] zeroinitializer, align 1
@.str = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(write, argmem: read, inaccessiblemem: none) uwtable
define dso_local noundef nonnull ptr @f072(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
  %2 = load i8, ptr %0, align 1, !tbaa !5
  store i8 %2, ptr @f072.r, align 1, !tbaa !5
  %3 = getelementptr inbounds nuw i8, ptr %0, i64 1
  %4 = load i8, ptr %3, align 1, !tbaa !5
  store i8 %4, ptr getelementptr inbounds nuw (i8, ptr @f072.r, i64 1), align 1, !tbaa !5
  store i8 0, ptr getelementptr inbounds nuw (i8, ptr @f072.r, i64 2), align 1, !tbaa !5
  ret ptr @f072.r
}
...
define dso_local noundef i32 @main(i32 noundef %0, ptr nocapture noundef readonly %1) local_unnamed_addr #1 {
  ...
  call void @llvm.lifetime.start.p0(i64 10240, ptr nonnull %3) #7
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(10240) %3, i8 0, i64 10240, i1 false)
  %4 = icmp eq i32 %0, 1
  br i1 %4, label %5, label %9

5:                                                ; preds = %2
  %6 = tail call ptr @__acrt_iob_func(i32 noundef 0) #7
  %7 = tail call i32 @fileno(ptr noundef %6)
  %8 = call i32 @read(i32 noundef %7, ptr noundef nonnull %3, i32 noundef 10240) #7
  br label %15

9:                                                ; preds = %2
  %10 = getelementptr inbounds nuw i8, ptr %1, i64 8
  %11 = load ptr, ptr %10, align 8, !tbaa !8
  %12 = tail call i32 (ptr, i32, ...) @open(ptr noundef %11, i32 noundef 0) #7
  %13 = call i32 @read(i32 noundef %12, ptr noundef nonnull %3, i32 noundef 10240) #7
  %14 = call i32 @close(i32 noundef %12) #7
  br label %15

15:                                               ; preds = %9, %5
  %16 = load i8, ptr %3, align 16, !tbaa !5
  store i8 %16, ptr @f072.r, align 1, !tbaa !5
  %17 = getelementptr inbounds nuw i8, ptr %3, i64 1
  %18 = load i8, ptr %17, align 1, !tbaa !5
  store i8 %18, ptr getelementptr inbounds nuw (i8, ptr @f072.r, i64 1), align 1, !tbaa !5
  store i8 0, ptr getelementptr inbounds nuw (i8, ptr @f072.r, i64 2), align 1, !tbaa !5
  %19 = call i32 (ptr, ...) @__mingw_printf(ptr noundef nonnull @.str, ptr noundef nonnull @f072.r) #7
  call void @llvm.lifetime.end.p0(i64 10240, ptr nonnull %3) #7
  ret i32 0
}
