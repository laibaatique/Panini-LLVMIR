; ModuleID = '391.c'
source_filename = "391.c"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-w64-windows-gnu"

@.str = private unnamed_addr constant [15 x i8] c"strlen(s) == 1\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"391.c\00", align 1
@.str.2 = private unnamed_addr constant [12 x i8] c"s[0] == 'b'\00", align 1

; Function Attrs: nounwind uwtable
define dso_local void @f391(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
...
12:                                               ; preds = %10
  tail call void @_assert(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 16) #9
  unreachable
...
18:                                               ; preds = %15
  %19 = load i8, ptr %3, align 16, !tbaa !5
...
22:                                               ; preds = %20
  call void @_assert(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 13) #9
  unreachable
...
26:                                               ; preds = %24
  call void @_assert(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 16) #9
  unreachable
