...
define dso_local noalias noundef ptr @f014(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
...
7:                                                ; preds = %1
  %8 = tail call dereferenceable_or_null(2) ptr @malloc(i64 noundef 2) #12
...
21:                                               ; preds = %15
  %22 = call noalias noundef dereferenceable_or_null(2) ptr @malloc(i64 noundef 2) #12
  %23 = load i8, ptr %3, align 16
  store i8 %23, ptr %22, align 1
  %24 = getelementptr inbounds nuw i8, ptr %22, i64 1
  store i8 0, ptr %24, align 1, !tbaa !5
  %25 = call i32 (ptr, ...) @__mingw_printf(ptr noundef nonnull @.str.1, ptr noundef nonnull %22) #10
