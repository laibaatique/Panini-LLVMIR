; ModuleID = '352.c'
source_filename = "352.c"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-w64-windows-gnu"

@.str = private unnamed_addr constant [9 x i8] c"a == 'a'\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"352.c\00", align 1
@.str.2 = private unnamed_addr constant [9 x i8] c"b == 'b'\00", align 1

; Function Attrs: nounwind uwtable
define dso_local void @f352(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
...
8:                                                ; preds = %1, %4
  tail call void @_assert(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 22) #9
  unreachable
...
7:                                                ; preds = %2
  %8 = tail call ptr @__acrt_iob_func(i32 noundef 0) #8
  %9 = tail call i32 @fileno(ptr noundef %8)
  %10 = call i32 @read(i32 noundef %9, ptr noundef nonnull %3, i32 noundef 10240) #8
  br label %17

11:                                               ; preds = %2
  %12 = getelementptr inbounds nuw i8, ptr %1, i64 8
  %13 = load ptr, ptr %12, align 8, !tbaa !8
  %14 = tail call i32 (ptr, i32, ...) @open(ptr noundef %13, i32 noundef 0) #8
  %15 = call i32 @read(i32 noundef %14, ptr noundef nonnull %3, i32 noundef 10240) #8
  %16 = call i32 @close(i32 noundef %14) #8
  br label %17

17:                                               ; preds = %11, %7
  %18 = call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %3) #8
...
20:                                               ; preds = %19, %17
  %21 = phi ptr [ %5, %19 ], [ %6, %17 ]
  %22 = load i8, ptr %3, align 16, !tbaa !5
  %23 = icmp eq i8 %22, 97
  br i1 %23, label %25, label %24

24:                                               ; preds = %20, %17
  call void @_assert(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 22) #9
  unreachable
...
28:                                               ; preds = %25
  call void @_assert(ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.1, i32 noundef 23) #9
  unreachable
